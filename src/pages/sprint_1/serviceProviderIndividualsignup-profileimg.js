...
function ServiceProviderIndividualsignupprofile () { 
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                ...
                                <div class="row mt-2 mb-4">
                                    <div class="col-md-12">
                                        <a href="/ServiceProviderIndividualsignupUpload"><button type="button" class="btn btn-login ">FINISH ACCOUNT SETUP</button></a>
                                    </div>
                                   </div>
...
export default ServiceProviderIndividualsignupprofile;