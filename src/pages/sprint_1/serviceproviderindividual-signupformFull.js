...
function ServiceproviderIndividualSignupformFull () {
                ...
                <div class="container">
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <a href="/ServiceprovicerOnsiteOffsite"><button type="button" class="btn btn-login mr-3 ">VERIFY MY ACCOUNT</button></a>
                                    <a href="/ServiceProviderIndividualsignupUpload"><button type="button" class="btn btn-outline-primary post-btn ">BACK</button></a>
                                </div>
                            </div>
...
export default ServiceproviderIndividualSignupformFull;