...
function ServiceProviderIndividualsignupUploaded () { 
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                ...
                                <div class="row mt-4 mb-4">
                                    <div class="col-md-12">
                                        <a href="/ServiceProviderIndividualsignupfull"><button type="button" class="btn btn-login ">FINISH ACCOUNT SETUP</button></a>
                                    </div>
                                   </div>
                            </div>
                        </div>
...
export default ServiceProviderIndividualsignupUploaded;