    ...
    <>
              ...
              <div class="col-md-9 col-7">
                <ul class="tophead-right">
                  <li class="d-none d-sm-block">
                    <a href="/service-signup">Register as a service provider</a>
                  </li>
                  <li>
                    <a href="/login">
              ...
              <div class="top-banner-searchbar position-relative">
                <div class="row align-items-center">
                  ...
                  <div class="col-md-5 text-right col-4 pr-2 pr-sm-4">
                    <button type="button" class="btn btn-login mr-2">
                      SEARCH
                    </button>
                  </div>
                </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-9">
                  <div class="service-head">
                    ...
                    <button type="button" class="btn btn-login mt-0 mt-sm-1">
                      READ MORE ABOUT US
                    </button>
                  </div>
                </div>
                ...
                <div class="row mt-4 mt-sm-5">
                  <div class="col-md-6 mb-4">
                    <div class="service-head">
                      ...
                      <button
                        type="button"
                        class="btn btn-warning exlpore-btn mt-2 mt-sm-3"
                      >
      ...
      <section class="position-relative py-4 py-sm-0">
              ...
              <div class="row justify-content-center">
                <div class="col-md-10">
                  <div class="top-bannerHead">
                    ...
                    <button type="button" class="btn btn-login mt-0 mt-sm-2">
                      POST A PROJECT
                    </button>
                  </div>
                </div>
        ...
        <img
          ...
          class="project-rightGirl d-none d-sm-block"
          alt=""
        />
      </section>
            ...
            <div class="col-md-10">
              <div class="service-head ">
                ...
                <span class="logo-img">
                  ...
                  <img src="images/google-logo.svg" height="25px" alt="" />{" "}
                  <br />{" "}
                  <img
