...
function ClientBookingscheduledDetails (props) {
    ...
    useEffect(() => {
      (async () => {
        let response = await fetchData(
          `/serviceProviders/${userData.id}/services/${state.service.id}`,
          "GET"
        );
                    ...
                    <div class="row mt-4 mt-sm-4 ">
                        <div class="col-md-8 mt-2">
                            <div class="service-head">
                                <h1><span>{service.headline}</span></h1>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="fixed-costbox">
                                      <div class="booked-forbox">
                                        <p>Booked for</p>
                                        <h6>{moment(
                      state.booking.date ? state.booking.date : new Date()
                    ).format("Do MMM YYYY")}</h6>
                                      </div>
                                
                                    <div class="row align-items-end">
                                        <div class="col-md-5 col-6">
                                            <h2>FIXED COST</h2>
                                            <h1>${'$'+state.booking.service.charge}</h1>
                                            <p>Listed on</p>
                                            <h6>{moment(
                      state.service.create_date ? state.service.create_date : new Date()
                    ).format("Do MMM YYYY")}</h6>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 text-right col-7">
                                            <h4>${'$'+state.service.visitingCharges}</h4>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
