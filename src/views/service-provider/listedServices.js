        ...
        <div class="container">
          <div class="row mt-2 mt-sm-3">
            <div class="col-md-12">
              <button
                type="button"
                class="btn btn-outline-dark mayment-btn mr-3 mb-2"
              >
                SCHEDULED{" "}
                <span class="notification-numb btn-notification">2</span>
              </button>
              <button
                type="button"
                class="btn btn-outline-dark mayment-btn mr-3 mb-2"
              >
                PAYMENT PENDING{" "}
                <span class="notification-numb btn-notification2">3</span>
              </button>
              <button
                type="button"
                class="btn btn-outline-dark mayment-btn mr-3 mb-2"
              ...
              <button
                type="button"
                class="btn btn-outline-dark mayment-btn mb-2 "
              >
                ADD NEW SERVICE
              </button>
            </div>
            ...
            <div class="row  align-items-center">
              ...
              <div class="col-md-5 col-8 pl-0">
                <div class="service-item">
                  <p>
                    #PT0000129899{" "}
                    <span class="servie-itemnmb">12th Jun 2022</span>
                    <span class="service-itemdraft">DRAFT</span>
                  </p>
                  <h6>
              ...
              <div class="col-md-5 col-8 pl-0">
                <div class="service-item">
                  <p>
                    #PT0000129899{" "}
                    <span class="servie-itemnmb">12th Jun 2022</span>
                    <span class="service-itemdraft service-itemhourly">
                      Hourly
                    </span>
                  </p>
                  <h6>
                    Dolor ut ab sit. Ut vero maiores autem culpa corrupti
                    reiciendis
                  </h6>
                </div>
              </div>
              <div class="col-md-6">
                <div class="service-publicSec service-publicpink">
                  <div class="row">
                    ...
                    <div class="col-md-4 text-right col-6 order-5 order-sm-5 mt-3 mt-sm-0">
                      <button class="btn btn-login new-loginbtn text-uppercase">
                        View Details
                      </button>
                    </div>
                  </div>
              ...
              <div class="col-md-5 col-8 pl-0">
                <div class="service-item">
                  <p>
                    #PT0000129899{" "}
                    <span class="servie-itemnmb">12th Jun 2022</span>
                    <span class="service-itemdraft serviceitemyfixed">
                      Fixed
                    </span>
                  </p>
                  <h6>
            ...
            <div class="col-md-12">
              <nav aria-label="...">
                <ul class="pagination pagination-lg">
                  ...
                  <li class="page-item">
                    <a class="page-link newpage-link" href="#">
                      .........
                    </a>
                  </li>
                  <li class="page-item">
